  ...
  const handleSaveMember = () => {
    if (
      ...
      toast({
        title: "Error",
        description:
          "First Name, Last Name, and Sex are required for each member.",
        variant: "destructive",
      });
      return;
    }
      ...
      clothDetails: {
        ...
        dressLength:
          memberFormData.sex === "Female"
            ? parseFloat(memberFormData.dressLength) || undefined
            : undefined,
        sliveLength:
          memberFormData.sex === "Female"
            ? parseFloat(memberFormData.sliveLength) || undefined
            : undefined,
        breast:
          memberFormData.sex === "Female"
            ? parseFloat(memberFormData.breast) || undefined
            : undefined,
        overBreast:
          memberFormData.sex === "Female"
            ? parseFloat(memberFormData.overBreast) || undefined
            : undefined,
        underBreast:
          memberFormData.sex === "Female"
            ? parseFloat(memberFormData.underBreast) || undefined
            : undefined,
        femaleSliveType:
          memberFormData.sex === "Female"
            ? memberFormData.femaleSliveType
            : undefined,
        femaleWegebType:
          memberFormData.sex === "Female"
            ? memberFormData.femaleWegebType
            : undefined,
        deret:
          memberFormData.sex === "Male"
            ? parseFloat(memberFormData.deret) || undefined
            : undefined,
        anget:
          memberFormData.sex === "Male"
            ? parseFloat(memberFormData.anget) || undefined
            : undefined,
        maleClothType:
          memberFormData.sex === "Male"
            ? memberFormData.maleClothType
            : undefined,
        maleSliveType:
          memberFormData.sex === "Male"
            ? memberFormData.maleSliveType
            : undefined,
        netela:
          memberFormData.sex === "Male"
            ? (memberFormData.netela as "Yes" | "No" | undefined)
            : undefined,
      },
    };
  ...
  const handleFamilySubmit = async (e: React.FormEvent) => {
    ...
    if (!familyName || !primaryPhone || !deliveryDate) {
      toast({
        title: "Error",
        description:
          "Family Name, Primary Phone, and Delivery Date are required.",
        variant: "destructive",
      });
      return;
    }
    ...
    formData.append(
      "phoneNumbers",
      JSON.stringify({ primary: primaryPhone, secondary: secondaryPhone })
    );
    ...
    formData.append(
      ...
      JSON.stringify({
        ...
        firstHalf: {
          paid: firstHalfPaid,
          amount: parseFloat(firstHalfAmount) || undefined,
        },
        secondHalf: {
          paid: secondHalfPaid,
          amount: parseFloat(secondHalfAmount) || undefined,
        },
      })
    );
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Create and add new members to a family group
        </p>
      </div>
      ...
      <form onSubmit={handleFamilySubmit} className="space-y-8">
       ...
       {/* PASTE THIS CODE IN ITS PLACE in AddFamily.tsx */}
<Card className="shadow-card border-0">
  <CardHeader>
    <CardTitle className="text-primary font-serif">
      Payment Details
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-2">
          <Checkbox
            ...
            onCheckedChange={(checked) => setFirstHalfPaid(!!checked)}
          />
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-2">
          <Checkbox
            ...
            onCheckedChange={(checked) => setSecondHalfPaid(!!checked)}
          />
                ...
                {Array.from({ length: numberOfMembers }, (_, index) => {
                  ...
                  if (activeMemberForm === memberNumber) {
                    return (
                      <Card
                        key={`form-${index}`}
                        className="p-6 bg-accent border-primary"
                      >
                                  ...
                                  <>
                                    ...
                                    <div className="space-y-2">
                                      ...
                                      >
                                        ...
                                        <SelectContent>
                                          <SelectItem value="Zrgf">
                                            A Zrgf
                                          </SelectItem>
                                          <SelectItem value="Fitted">
                                            B Fitted
                                          </SelectItem>
                                          <SelectItem value="Kbeto">
                                            C Kbeto
                                          </SelectItem>
                                        </SelectContent>
                                      </Select>
        ...
        <div className="flex justify-end">
          <Button
            ...
            disabled={
              isSubmitting ||
              members.length !== numberOfMembers ||
              numberOfMembers === 0
            }
          >
